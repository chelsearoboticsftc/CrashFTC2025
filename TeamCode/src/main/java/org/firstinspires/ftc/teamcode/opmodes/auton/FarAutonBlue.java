...
public class FarAutonBlue extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        drive.localizer.setPose(new Pose2d(0, 0 , 180));
        ...
        if (limelight.getresult() != null) {
            if (limelight.getresult().isValid()) {
                ...
                if (limelight.getresult().getTx() < -0.6) {
                    while (limelight.getresult().getTx() < -0.6) {
                        shooter.aim(-0.2);
                    }
                    shooter.aim(0);
                ...
                if (limelight.getresult().getTx() > -0.4) {
                    while (limelight.getresult().getTx() > -0.4) {
                        shooter.aim(0.2);
                    }
                    shooter.aim(0);
