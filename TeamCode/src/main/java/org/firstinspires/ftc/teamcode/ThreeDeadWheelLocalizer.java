...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        ...
        public double par0YTicks = 1007.93749998406; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = -1007.93749998406; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -335.9791666613533; // x position of the perpendicular encoder (in tick units)
    }
